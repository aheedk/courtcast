  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-36 right-4 z-30 w-11 h-11 rounded-full bg-gradient-to-br from-white/95 via-sky-50/95 to-emerald-50/95 backdrop-blur-xl shadow-lg shadow-emerald-950/10 border border-emerald-100 flex items-center justify-center text-emerald-950 hover:from-white hover:to-emerald-50 disabled:opacity-60"
      >
      ...
      {error && (
        <div
          role="status"
          className="fixed bottom-48 right-4 z-30 max-w-[260px] bg-white border border-neutral-200 shadow-lg shadow-neutral-900/10 rounded-xl px-3 py-2 text-xs text-neutral-700"
        >
          {error}
        </div>
      )}
