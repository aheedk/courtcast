export function MapLegend() {
  return (
    <div className="absolute bottom-24 left-3 z-20 bg-gradient-to-b from-white/95 via-emerald-50/95 to-sky-50/95 backdrop-blur-xl rounded-lg shadow-lg shadow-emerald-950/10 border border-emerald-100/80 px-2.5 py-2 text-[10px] text-neutral-600 flex flex-col gap-1">
