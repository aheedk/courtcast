export const env = {
  ...
  appleClientId: import.meta.env.VITE_APPLE_CLIENT_ID ?? 'com.courtclimate.app',
  appleRedirectUri: import.meta.env.VITE_APPLE_REDIRECT_URI ?? 'https://courtclimate.com/login',
